...
import cells.FiveStateCell;
import cellsociety_team13.Location;
import cellsociety_team13.Society;
import javafx.scene.paint.Color;


public abstract class ForagingAntsCell extends FiveStateCell{
	public static final int stateObstacle = 0;
	public static final int stateNest = 1;
	public static final int stateFoodSource = 2;
	public static final int statePatch = 3;
	...
	protected void updatePheromoneLevels(Society currentSociety, Society newSociety, List<Location> neighborsLoc, String label){
		double amount = 0.0;
